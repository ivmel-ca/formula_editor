...
const FormulaEditorButtonbar = ({isItalic, isSubscript, isSuperscript, isSymbol, isEmoji, addSimpleFormat, addRoot, addFormula, addFraction, onSymbolClick, symbolPopover, onEmojiClick, emojiPopover, classes}) => (
    <div className = {classes.root} >
        ...
        <SquareButton onMouseDown = { addRoot }  icon = {<img src = {rooticon} className = {classes.iconRoot} alt = ''/>} classes = {{root: classes.squareButtonRoot}}/>
